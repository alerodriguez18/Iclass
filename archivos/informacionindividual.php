...
<?php
 ...
 $sql1="Select comentario,foto,fecha,para,por from muro where para='".$idusuario." 'ORDER BY idcomentario desc;";
 $resultado1=mysql_query($sql1,$conexion)or die("error");
$sql2="Select nombre,apellidos from usuarios where usuario='".$idusuario."';";
    $resultado2=mysql_query($sql2,$conexion)or die("error");
	$row2=mysql_fetch_array($resultado2);
	
echo "<div id=muro><center><font color=#FFFFFF size=+2>MURO DE $row2[0] $row2[1]</font></center></div>";
echo "<a href='publicarform.php?idusuario=$idusuario' target='menuprincipal'><center><font color=#FFFFFF>[PUBLICAR EN SU MURO]</a></font></center><br>";
	 ...
	 echo "<center><img src='$row1[1]' width='150' height='150' width=150 height=150 ></center></a><br>";
      echo "<center><font color=#FFFFFF> $row1[0]</font><center><br>";
       echo "<center><font color=#FFFFFF>Por: $row1[4]</font></center><br>";
           echo "<center><font color=#FFFFFF>El: $row1[2]</font></center><br>";
	  echo "<hr>";
	  }
	 else if($row1[1]!=""){
  echo "<center><img src='$row1[1]' width='150' height='150' width=150 height=150 ></center></a><br>";
